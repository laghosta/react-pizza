...
import {calcCartPizzasCount, calcCartPizzasPrice, clearCart} from "../../redux/slices/cartSlice";
                ...
                :
                    <div className={styles.cart}>
                        <div className={styles.cart__top}>
                            ...
                            <div onClick={()=>dispatch(clearCart())} className={styles.cart__clear}>
                                <svg
                                    width="20"
                                    height="20"
                                    viewBox="0 0 20 20"
                        ...
                        <div className={styles.content__items}>
                            {
                                cartPizzas.map((el, id)=>
                                    <CartItem pizza ={el} key={id}/>)
                            }
                        </div>
                        ...
                        <span>
                            Всего пицц: <b>{pizzasCount} шт.</b>
                                ...
                                <span>
                          Сумма заказа: <b style={{color:"#fe5f1e"}}>{pizzasPrice} ₴</b>
                        </span>
                            </div>
